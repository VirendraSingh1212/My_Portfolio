...
import { motion } from "motion/react"; // Ensure Image is imported from 'next/image'
  ...
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
        ...
        className="max-w-2xl mx-auto font-Ovo">
          Passionate IT student skilled in programming and web development, eager to apply knowledge in real-world projects. Seeking an
          internship to enhance technical expertise and contribute to impactful solutions.
        </motion.p>
        <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
          ...
          transition={{duration: 0.6, delay: 1}}
           href="#contact" className="px-10 py-3 border border-white rounded-full bg-black text-white flex items-center gap-2">
            Contact Me
            <Image src={assets.right_arrow_white} alt="Right Arrow" className="rounded-full w-4" />
          </motion.a>
          <motion.a 
            initial={{y: 30, opacity:0}}
            whileInView={{y: 0, opacity: 1}}
